        ...
        <div class="header">
            <div class="header_back">
                ...
                <div class="header_logo">
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>/index"><img src="<?php bloginfo('template_directory'); ?>/images/logo.png" alt="クッピー乳児園"></a>
                </div>
            </div>
        </div>
<!-- pc menu -->
        <div class="nav_menu pc">
            <div class="g-nav-list">
                <ul class="clearfix">
                    <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>/index"><i class="fa fa-solid fa-crown"></i></br>TOP</a></li>  
...
<!-- sp menu -->        
        <div class="nav_menu sp">
            ...
            <nav class="globalMenuSp">
                <ul>
                    <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>/index"></i>TOP</a></li>  
                    <li><a href="<?php echo get_permalink( get_page_by_path( 'news' )->ID ); ?>"><i class="fa fa-regular fa-lightbulb"></i>お知らせ</a></li>  
                    <li><a href="<?php echo get_permalink( get_page_by_path( 'hoiku' )->ID ); ?>">
                        <i class="fa fa-brands fa-itunes-note"></i>保育内容</a></li>  
                    <li><a href="<?php echo get_permalink( get_page_by_path( 'introduce' )->ID ); ?>"><i class="fa fa-solid fa-palette"></i>園の紹介</a></li>  
                    <li><a href="<?php echo get_permalink( get_page_by_path( 'schedule' )->ID ); ?>">
                    <i class="fa fa-solid fa-paw"></i>園の生活</a></li>
                    <li><a href="<?php echo get_permalink( get_page_by_path( 'album' )->ID ); ?>">
                    <i class="fa fa-solid fa-image"></i>アルバム</a></li>
                    <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>/news#recruit">
                    <i class="fa fa-solid fa-tree"></i>採用情報</a></li>
                </ul>
            </nav>
        </div>
    </header>